...
import TextPressure from "../components/ui/shadcn-io/text-pressure.tsx";
...
const socials = [
  ...
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/AnujBhagat08" },
];
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            >
              Hi, I’m a passionate Front-End Developer focused on creating
              smooth, scalable, and user-friendly digital experiences. I enjoy
              building clean interfaces, reliable backend systems, and solving
