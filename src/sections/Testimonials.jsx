...
const testimonials = [
  {
    name: "Viraj Patle",
    role: "Software Engineer at SS Infotech",
    review:
      "Anuj is a visionary developer. His attention to detail and creativity blew us away. Our project was a massive success because of him.",
    image: VP,
  },
  {
    name: "Karan Verma",
    ...
    review:
      "He understands requirements quickly, works with focus, and delivers clean, reliable results.!",
    image: w1,
  },
  {
    name: "Amy Jacobsan",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 max-w-6xl w-full">
        {testimonials.map((t, i) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 flex flex-col items-center text-center transform transition duration-500 hover:scale-105 hover:-rotate-1"
          >
            <img
              src={t.image}
              alt={t.name}
